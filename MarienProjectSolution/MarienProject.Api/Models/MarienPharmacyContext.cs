...
public partial class MarienPharmacyContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__City__3214EC07D013A817");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Conversi__3214EC07FB4982FC");
            ...
            entity.HasOne(d => d.UnitOfMeasurement).WithMany(p => p.Conversions)
                ...
                .HasConstraintName("FK__Conversio__UnitO__06CD04F7");
        });

        modelBuilder.Entity<Currency>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Currency__3214EC07EEC9479D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Customer__3214EC071CBA2E66");

            entity.ToTable("Customer");

            entity.HasIndex(e => e.UserId, "UQ__Customer__1788CC4D6EFC49D5").IsUnique();

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147405E9311A1").IsUnique();

            entity.HasIndex(e => e.Phone, "UQ__Customer__5C7E359E6446560D").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Customer__3214EC070A52C8A0");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.CustomerAddresses)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CustomerA__Custo__09A971A2");

            entity.HasOne(d => d.Municipality).WithMany(p => p.CustomerAddresses)
                .HasForeignKey(d => d.MunicipalityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CustomerA__Munic__0A9D95DB");
        });

        modelBuilder.Entity<DeliveryType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Delivery__3214EC0721156586");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC07C54D1D10");

            entity.ToTable("Employee");

            entity.HasIndex(e => e.UserId, "UQ__Employee__1788CC4DEBD8F02F").IsUnique();

            entity.HasIndex(e => e.EmailAddress, "UQ__Employee__49A1474066CD73FC").IsUnique();

            entity.HasIndex(e => e.Phone, "UQ__Employee__5C7E359E8DB72ABF").IsUnique();
        ...
        modelBuilder.Entity<ExchangeRate>(entity =>
        {
            ...
            entity.HasOne(d => d.Currency).WithMany()
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ExchangeR__Curre__0D7A0286");
        });

        modelBuilder.Entity<GenericMedicationName>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__GenericM__3214EC07DDFA4F31");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Internal__3214EC0775AB12E5");
            ...
            entity.HasOne(d => d.StoredMedication).WithMany(p => p.InternalMovements)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__InternalM__Store__0E6E26BF");
        });

        modelBuilder.Entity<InvoiceStatus>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__InvoiceS__3214EC07B0581B22");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Medicati__3214EC07F879764D");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Medications)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Medicatio__Categ__0F624AF8");
        });

        modelBuilder.Entity<MedicationCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Medicati__3214EC07A6E7A597");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Medicati__3214EC07D9A51233");
        ...
        modelBuilder.Entity<MedicationInStock>(entity =>
        {
            ...
            entity.HasOne(d => d.InternalMovement).WithMany(p => p.MedicationInStocks)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Medicatio__Inter__1332DBDC");

            entity.HasOne(d => d.Location).WithMany(p => p.MedicationInStocks)
                .HasForeignKey(d => d.LocationId)
                .HasConstraintName("FK__Medicatio__Locat__14270015");

            entity.HasOne(d => d.StoredMedication).WithMany(p => p.MedicationInStocks)
                .HasForeignKey(d => d.StoredMedicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Medicatio__Store__151B244E");
        });

        modelBuilder.Entity<MedicationLaboratory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Medicati__3214EC07B5C6684C");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menu__C99ED230AE0BAA0D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Municipa__3214EC073002340A");
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Municipalities)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Municipal__City___17F790F9");
        });

        modelBuilder.Entity<Prescription>(entity =>
        {
            entity.HasKey(e => e.PrescriptionId).HasName("PK__Prescrip__40130832636149E2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Purchase__3214EC0719C08D78");
            ...
            entity.HasOne(d => d.InvoiceStatus).WithMany(p => p.Purchases)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Purchase__Invoic__18EBB532");

            entity.HasOne(d => d.Supplier).WithMany(p => p.Purchases)
                .HasForeignKey(d => d.SupplierId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Purchase__Suppli__19DFD96B");
        });

        modelBuilder.Entity<PurchaseDetail>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Purchase__3214EC07545E086B");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.PurchaseDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PurchaseD__Emplo__1AD3FDA4");

            entity.HasOne(d => d.Purchase).WithMany(p => p.PurchaseDetails)
                .HasForeignKey(d => d.PurchaseId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PurchaseD__Purch__1BC821DD");

            entity.HasOne(d => d.StoredMedication).WithMany(p => p.PurchaseDetails)
                .HasForeignKey(d => d.StoredMedicationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PurchaseD__Store__1CBC4616");
        });

        modelBuilder.Entity<RefreshTokenHistory>(entity =>
        {
            entity.HasKey(e => e.HistorialTokenId).HasName("PK__RefreshT__1CD201C1DFD8E96D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3214EC07E5FB42A8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Sale__3214EC0780B4AACC");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Sales)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Sale__Customer_I__1EA48E88");

            entity.HasOne(d => d.DeliveryEmployee).WithMany(p => p.SaleDeliveryEmployees)
                .HasForeignKey(d => d.DeliveryEmployeeId)
                .HasConstraintName("FK__Sale__DeliveryEm__1F98B2C1");

            entity.HasOne(d => d.DeliveryType).WithMany(p => p.Sales)
                .HasForeignKey(d => d.DeliveryTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Sale__DeliveryTy__208CD6FA");

            entity.HasOne(d => d.Employee).WithMany(p => p.SaleEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("FK__Sale__Employee_I__2180FB33");

            entity.HasOne(d => d.InvoiceStatus).WithMany(p => p.Sales)
                .HasForeignKey(d => d.InvoiceStatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Sale__InvoiceSta__22751F6C");

            entity.HasOne(d => d.Municipality).WithMany(p => p.Sales)
                .HasForeignKey(d => d.MunicipalityId)
                .HasConstraintName("FK__Sale__Municipali__236943A5");
        });

        modelBuilder.Entity<SaleDetail>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__SaleDeta__3214EC076CE17BF0");
            ...
            entity.HasOne(d => d.MedicationInStock).WithMany(p => p.SaleDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SaleDetai__Medic__245D67DE");

            entity.HasOne(d => d.Sale).WithMany(p => p.SaleDetails)
                .HasForeignKey(d => d.SaleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SaleDetai__Sale___25518C17");
        });

        modelBuilder.Entity<ShelfCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ShelfCat__3214EC074B643C12");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ShelfLoc__3214EC0770DC14CB");
            ...
            entity.HasOne(d => d.Shelf).WithMany(p => p.ShelfLocationCategories)
                ...
                .HasConstraintName("FK__ShelfLoca__Shelf__2645B050");
        });

        modelBuilder.Entity<StorageCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__StorageC__3214EC0714847D6C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__StorageL__3214EC076069C031");
            ...
            entity.HasOne(d => d.Storage).WithMany(p => p.StorageLocationCategories)
                ...
                .HasConstraintName("FK__StorageLo__Stora__2739D489");
        });

        modelBuilder.Entity<StoredMedication>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__StoredMe__3214EC07733C06F5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UnitOfMe__3214EC07CD1A4E45");
